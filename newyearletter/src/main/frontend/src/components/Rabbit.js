...
class Rabbit extends Component {
  ...
  componentDidMount() {
    ...
    $('#ear_left-2').on('click', () => {
      $("#rabbit #ear-left").attr("style", left_ear_2_style);
      $("#rabbit #ear-left").attr("d", left_ear_2_d);
    })
    $('#ear_right-1').on('click', () => {
      $("#rabbit #ear-right").attr("style", right_ear_1_style);
      $("#rabbit #ear-right").attr("d", right_ear_1_d);
    })
    $('#ear_right-2').on('click', () => {
      $("#rabbit #ear-right").attr("style", right_ear_2_style);
      $("#rabbit #ear-right").attr("d", right_ear_2_d);
    })
  }
  ...
  render() {
      return(
          <>
            ...
            <div>
              <div>
                <button id="ear_left-1">왼쪽 귀1</button>
                <button id="ear_left-2">왼쪽 귀2</button>
              </div>
              
              <div>
                <button id="ear_right-1">오른쪽 귀1</button>
                <button id="ear_right-2">오른쪽 귀2</button>
              </div>
            </div>
            <div><br/></div>
          </>
